...
<div class="col-sm-12 well">
    ...
    <form:form commandName="userz" method="post" action="/Paluch/admin" id="userForm" >   
        ...
        <br />
        <input type="submit" class="btn btn-default  btn-lg col-sm-offset-9"  name="saveAdmUser" value="Zarejestruj" />
    </form:form>
</div>
            </div>
    </div>
